            ...
            if (type != tokens.end())
            {
                ...
                if (idToken != tokens.end())
                {
                    ...
                    if (type->second == "NODE")
                    {
                        ...
                        {
                            _nodes.emplace_back(std::make_unique<GraphNode>(id)); // Here, we used std::make_unique to create new GraphNode instance
                    ...
                    if (type->second == "EDGE")
                    {
                        ...
                        if (parentToken != tokens.end() && childToken != tokens.end())
                        {
                            ...
                            edge->SetChildNode((*childNode).get()); // pass raw pointer 
                            edge->SetParentNode((*parentNode).get()); // pass raw pointer
...
*/
    ...
    // _chatBot = rootNode->GetChatBot(); // Update ChatLogic's handle to the ChatBot
