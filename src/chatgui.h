...
private:
    ...
    std::unique_ptr<ChatLogic> _chatLogic; // Use unique_ptr for exclusive ownership
...
public:
    ...
    // getter / setter
    ChatLogic *GetChatLogicHandle() { return _chatLogic.get(); } // Use get() to return raw pointer
