...
private:
    ...
    GraphNode *_currentNode; // pointer to current node
    GraphNode *_rootNode;
...
public:
    ...
    ChatLogic* GetChatLogicHandle() { return _chatLogic; } // communication 
    wxBitmap *GetImageHandle() { return _image; } // file I/O
